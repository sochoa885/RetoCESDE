              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url(); ?>">
                  ...
                  <form class="user" action="<?php echo base_url(); ?>/admin/index" method="POST">
